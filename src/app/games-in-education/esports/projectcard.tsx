...
export default function ProjectCard({
    ...
    const { title, description, image, theme, tag, tags } = project;
    ...
    return (
        ...
        >
            ...
            <div className="mt-4">
                ...
                <h3 className="mt-2 text-2xl font-medium leading-tight text-white md:text-3xl">
                    {description}
                </h3>
