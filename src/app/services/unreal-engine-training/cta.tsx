        ...
        <section className="relative w-full overflow-hidden bg-black py-24 md:py-32">
            <div className="mx-auto flex max-w-5xl flex-col items-center px-6 text-center">
                ...
                >
                    <Link
                        href="/contact"
                        className="inline-flex items-center justify-center rounded-lg bg-[#FBCD00] px-10 py-4 text-lg font-semibold text-[#15151E] transition-opacity hover:opacity-90"
                    >
                        Contact Us
                    </Link>
                </motion.div>
