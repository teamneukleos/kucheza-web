...
const services = [
    {
        title: "Our Games",
        href: "/our-games",
        image: "/services/ourgames.png",
    },
    {
        title: "Game Art Co-Dev",
        href: "/services/game-art-co-dev",
        image: "/services/art.png",
    },
    {
        title: "Unreal Engine Training",
        href: "/services/unreal-engine-training",
        image: "/services/unreal.png",
    },
    {
        title: "Games in Education",
        href: "/games-in-education",
...
export default function Services() {
    return (
        <section className="w-full bg-[#44484B] py-20 md:py-28">
            ...
            {/* Structural Container: Centers layout identically to the Navbar and Hero */}
            <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 md:px-8">
                ...
                <motion.p
                    ...
                    viewport={{ once: true }}
                    className="text-3xl font-medium text-[#24F2BE]"
                >
                    What we do
                </motion.p>
...
function ServiceItem({
    ...
    return (
        <Link
            href={service.href}
            className="group relative flex w-full items-center justify-between gap-4 overflow-hidden border-b border-white/10 py-6 text-white/50 transition-all duration-300 hover:text-white md:py-7"
        >
