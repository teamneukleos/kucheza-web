            ...
            <div className="mx-auto flex max-w-5xl flex-col items-center px-6 text-center">
                ...
                >
                    <button
                        type="button"
                        onClick={open}
                        className="inline-flex items-center justify-center rounded-lg bg-[#40F7CC] px-10 py-4 text-lg font-semibold text-[#15151E] transition-all hover:translate-x-5 hover:bg-[#36e6be]"
                    >
                        Contact Us
                    </button>
                </motion.div>
