    ...
    <section className="w-full bg-[#44484B] py-20 md:py-28">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 md:px-8">
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-5xl font-medium text-[#FFD600]"
        >
          Course Content
        </motion.p>
        <div className="mt-6">
...
function ServiceItem({
  ...
  return (
    <div className="group relative flex w-full items-center justify-between gap-4 overflow-hidden py-6 text-white/50 transition-all duration-300 hover:text-white md:py-7">
